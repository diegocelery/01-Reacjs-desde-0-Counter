...
export default defineConfig({
  plugins: [react(),VitePWA({
    includeAssets: ['vite.svg', 'ios','android','windows11'], /* Para cachear archivos y contenido de carptas*/
    devOptions: {
      enabled: true /* En modo desarrollo (lofalhost), hace que se injecte el serviceworker */
    },
    injectRegister: 'auto', /*Para produccion se usa así. El Servicerworker se inyectara solo en producción. En localhost no aparecerá.*/
    
    //https://vite-pwa-org.netlify.app/guide/pwa-minimal-requirements.html#web-app-manifest
    manifest: {
      name: 'PWA REACT AND VITE',
      short_name: 'PWA REACT',/* PARA PANTALLA DE INICIO Y MENU DE APLICACIONES, ETC */
      description: 'React and Vite app + PWA MANIFEST',
      theme_color: '#ffffff', /* color de  parte superior de la app ya instalada*/
